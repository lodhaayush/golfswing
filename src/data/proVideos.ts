...
export const PRO_VIDEOS: ProVideoReference[] = [
  ...
  },
  {
    ...
    isRightHanded: true,
    phaseSegments: [
      { phase: 'address' as SwingPhase, startFrame: 0, endFrame: 8, startTime: 0, endTime: 0.6, duration: 0.6 },
      { phase: 'backswing' as SwingPhase, startFrame: 9, endFrame: 15, startTime: 0.6, endTime: 1.067, duration: 0.467 },
      { phase: 'top' as SwingPhase, startFrame: 16, endFrame: 17, startTime: 1.067, endTime: 1.2, duration: 0.133 },
      { phase: 'downswing' as SwingPhase, startFrame: 18, endFrame: 19, startTime: 1.2, endTime: 1.333, duration: 0.133 },
      { phase: 'impact' as SwingPhase, startFrame: 20, endFrame: 21, startTime: 1.333, endTime: 1.467, duration: 0.133 },
      { phase: 'follow-through' as SwingPhase, startFrame: 22, endFrame: 32, startTime: 1.467, endTime: 2.2, duration: 0.733 },
